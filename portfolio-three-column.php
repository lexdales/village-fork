...
<div id="content">
	...
	$image_url_thumb = wp_get_attachment_image_src($image_id, 'portfolio_three_column');
	$portfolio_media_type = get_post_meta($post->ID, 'p_portfolio_media_type', 12349);
	$gallery_thumbnail_src = get_bloginfo('template_url').'/timthumb.php?src=' . $image_url[0] . '&amp;w=214&amp;h=180&amp;zc=1&amp;q=100';
	...
	?>
			...
			<div class="portfolio_three_post <?php if ($column_count == 3) echo "column-last"; ?>">
				...
				<iframe title="YouTube video player" allowfullscreen src="http://www.youtube.com/embed/<?php echo get_post_meta($post->ID, 'p_portfolio_youtube_id', 67645); ?>?hd=1&wmode=opaque" frameborder="0" height="180" width="214"></iframe>
				...
				<iframe src="http://player.vimeo.com/video/<?php echo get_post_meta($post->ID, 'p_portfolio_vimeo_id', 67645); ?>?title=0&amp;byline=0&amp;portrait=0" width="214" height="182" frameborder="0"></iframe>
				...
				<a href="<?php echo get_post_meta($post->ID, 'p_portfolio_shv', 67647); ?>" style="display:block;width:214px;height:180px" id="<?php echo $post->post_name; ?>_unique"></a> 
        ...
        autoBuffering: true,
				...
				<div id="<?php echo $post->post_name; ?>_unique" style="display:block;width:214px;height:180px;"></div>
	...
	if ($column_count == 3) :  echo '<div class="clear"></div>'; $column_count = 0; endif;
	...
	<script type="text/javascript">
		...
		$(".portfolio_three_post a[rel^='prettyPhoto']").prettyPhoto({animationSpeed:'slow',slideshow: '6000'});
