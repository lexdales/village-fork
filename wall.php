...
/*
Template Name: jQuery Wall Portfolio
*/
...
<a title="<?php echo get_post_meta($post->ID, "blueprint_wall_item_description", 23243); ?>" href="<?php echo $lightbox_link; ?>" title="<?php echo get_post_meta($post->ID, "blueprint_wall_item_description", 23243); ?>" rel="prettyPhoto[pp_gal]"><img src="<?php echo $image_url[0]; ?>" alt="<?php the_title(); ?>" /></a>
