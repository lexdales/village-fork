...
function optionsframework_add_page() {
	...
	$of_page = add_theme_page(__('Theme Options',"studio"), __('Theme Options',"studio"), 'edit_theme_options', 'options-framework','optionsframework_page');
...
function optionsframework_page() {
    ...
    <div id="optionsframework" class="postbox">
        ...
        <div id="optionsframework-submit">
			<input type="submit" class="button-primary" name="update" value="<?php _e('Save Options', "studio"); ?>" />
            <input type="submit" class="reset-button button-secondary" name="reset" value="<?php _e('Restore Defaults', "studio"); ?>" onclick="return confirm( '<?php print esc_js(__('Click OK to reset. Any theme settings will be lost!', "studio")); ?>' );" />
            <div class="clear"></div>
		</div>
	</form>
</div> <!-- / #container -->
