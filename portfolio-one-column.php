...
<div id="content">
	...
	$gallery_thumbnail_src = get_bloginfo('template_url').'/timthumb.php?src=' . $image_url[0] . '&amp;w=680&amp;h=400&amp;zc=1&amp;q=100';
	...
	?>
			...
			<div class="portfolio_one_post <?php if ($column_count == 1) echo "column-last"; ?>">
				...
				<a href="<?php echo get_post_meta($post->ID, 'p_portfolio_shv', 67647); ?>" style="display:block;width:680px;height:400px" id="<?php echo $post->post_name; ?>_unique"></a> 
        ...
        autoBuffering: true,
				...
				<div id="<?php echo $post->post_name; ?>_unique" style="display:block;width:680px;height:400px;"></div>
	...
	if ($column_count == 1) :  echo '<div class="clear"></div>'; $column_count = 0; endif;
