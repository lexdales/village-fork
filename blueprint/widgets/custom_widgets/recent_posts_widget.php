...
class RPWT_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'rpwt_widget', // Widget ID
            __('Recent Posts Widget', 'village'), // Widget name (use your own label)
            array( 'description' => __( 'Displays recent posts', 'village' ) ) // Args
        );
    }
                ...
                while ($query->have_posts()) : $query->the_post();
                    ...
                    <div class="posts_item">
                        ...
                        <div class="widget_posts_info">
                            <a class="widget_posts_title" href="<?php the_permalink(); ?>">
                                <?php the_title(); ?>
                            </a>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <?php comments_popup_link(
                                            __("No Comments","village"),
                                            __("One Comment","village"),
                                            '% ' . __("Comments","village"),
                                            '',
                                            __("Comments Closed","village")
                                        ); ?>
                                    </li>
                                </ul>
                            </span>
